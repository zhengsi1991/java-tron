...
public class WalletTestMutiSign005 {
  ...
  public void testMutiSignForProposal() {
    ...
    Assert.assertTrue(PublicMethedForMutiSign.createProposalWithPermissionId(witness001Address,witnessKey001,
    ...
    Assert.assertTrue(PublicMethedForMutiSign.approveProposalWithPermissionId(
    ...
    Assert.assertTrue(PublicMethedForMutiSign.deleteProposalWithPermissionId(
        witness001Address, witnessKey001, proposalId, 2,
