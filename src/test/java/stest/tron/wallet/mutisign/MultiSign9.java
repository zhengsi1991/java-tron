...
//循环
    Assert.assertTrue(PublicMethed
        .sendcoin(test001Address, 100000000000L, fromAddress, testKey002,
            blockingStubFull));
  ...
  public void addressPermission(String addKey, String accountPermissionJson) {
    PublicMethed.freezeBalance(test001Address, 100000000L, 0,
    ...
    Assert.assertTrue(PublicMethedForMutiSign
        .accountPermissionUpdateWithPermissionId(accountPermissionJson, test001Address, dev001Key,
            blockingStubFull, 0,
            permissionKeyString));
    PublicMethed.unFreezeBalance(test001Address, dev001Key, 0,
