...
//            containsString(
//                "contract validate error : address should be distinct in permission Active1"));
  ...
  public void testMultiSignAddDupAssressActive_1() {
    //active加多个同一个地址，是1个PermissionID
...
//                "contract validate error : address should be distinct in permission Active1"));
  ...
  public void testMultiSignAddDupAssressActive_2() {
    //active加多个同一个地址,不是1个PermissionID
