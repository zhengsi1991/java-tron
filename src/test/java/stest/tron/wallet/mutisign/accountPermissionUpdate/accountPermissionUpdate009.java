...
public class accountPermissionUpdate009 {
  ...
  public void testActiveParent05() {
    ...
    String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"\",\"threshold\":2,\"keys\":["
            + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":3}]},"
            + "\"active_permissions\":["
            + "{\"parent\":\"active\",\"type\":2,\"permission_name\":\"active0\",\"threshold\":1,"
            + "\"operations\":\"7fff1fc0033e0000000000000000000000000000000000000000000000000000\","
            + "\"keys\":["
            + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
            + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}"
  ...
  public void testActiveParent06() {
    ...
    String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"\",\"threshold\":2,\"keys\":["
            + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":3}]},"
            + "\"active_permissions\":["
            + "{\"parent\":\"owner\",\"type\":2,\"permission_name\":\"active0\",\"threshold\":1,"
            + "\"operations\":\"7fff1fc0033e0000000000000000000000000000000000000000000000000000\","
            + "\"keys\":["
            + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
            + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}"
  ...
  public void testActiveParent07() {
    ...
    String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"\",\"threshold\":2,\"keys\":["
            + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":3}]},"
            + "\"active_permissions\":["
            + "{\"parent\":\"witness\",\"type\":2,\"permission_name\":\"active0\",\"threshold\":1,"
            + "\"operations\":\"7fff1fc0033e0000000000000000000000000000000000000000000000000000\","
            + "\"keys\":["
            + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
            + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}"
  ...
  @Test
  public void testActiveParent09() {
    // parent_id = null
    List<String> ownerPermissionKeys = new ArrayList<>();
    ...
    String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"\",\"threshold\":2,\"keys\":["
            + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":3}]},"
            + "\"active_permissions\":["
            + "{\"parent_id\":" + null +",\"type\":2,\"permission_name\":\"active0\",\"threshold\":1,"
            + "\"operations\":\"7fff1fc0033e0000000000000000000000000000000000000000000000000000\","
            + "\"keys\":["
            + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
            + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}"
  ...
  @Test
  public void testActiveParent10() {
    // parent_id = 1
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test
  public void testActiveParent11() {
    // parent_id = 2
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test
  public void testActiveParent12() {
    // parent_id = 3
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test
  public void testActiveParent13() {
    // parent_id = -1
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test
  public void testActiveParent14() {
  ...
  @Test
  public void testActiveParent15() {
