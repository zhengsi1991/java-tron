...
@Slf4j
public class accountPermissionUpdate017 {
  ...
  @Test(enabled = false)
  public void testWitnessAddress0311() {
  ...
  @Test
  public void testWitnessAddress08() {
  ...
  @Test
  public void testWitnessAddress09() {
    // address count is 5
    String ownerKey = witnessKey001;
    byte[] ownerAddress = new WalletClient(ownerKey).getAddress();
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  @Test
  public void testWitnessAddress10() {
    // address count = 0
    String ownerKey = witnessKey001;
    byte[] ownerAddress = new WalletClient(ownerKey).getAddress();
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  @Test
  public void testWitnessAddress11() {
    // address =
    String ownerKey = witnessKey001;
    byte[] ownerAddress = new WalletClient(ownerKey).getAddress();
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  @Test
  public void testWitnessAddress12() {
    // address = null
    String ownerKey = witnessKey001;
    byte[] ownerAddress = new WalletClient(ownerKey).getAddress();
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  @Test
  public void testWitnessAddress13() {
    // address = "1.1"
    String ownerKey = witnessKey001;
    byte[] ownerAddress = new WalletClient(ownerKey).getAddress();
    PublicMethed.waitProduceNextBlock(blockingStubFull);
