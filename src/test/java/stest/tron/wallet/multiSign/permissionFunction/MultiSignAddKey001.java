...
@Slf4j
public class MultiSignAddKey001 {
  ...
  public void testMultiSignAddKey() {
    ...
    permissionKeyString[2] = sendAccountKey2;
    permissionKeyString[3] = sendAccountKey3;
    permissionKeyString[4] = sendAccountKey4;

    Assert.assertTrue(PublicMethedForMutiSign
        .sendcoin(test005Address, 100L, testAddress, dev001Key, blockingStubFull,
            permissionKeyString));
    logger.info(
        "Balance:" + PublicMethed.queryAccount(test005Address, blockingStubFull).getBalance());
    Assert.assertTrue(
        PublicMethed.queryAccount(test005Address, blockingStubFull).getBalance() == 100);
