...
public class MultiSignAddKey006 {
  ...
  public void testMultiSignAddKey() {
    PublicMethed
        .sendcoin(test001Address, 6000000000L, fromAddress, testKey002,
            blockingStubFull);
    ...
    long deployFeeLimit = 1000000000;
    ...
    byte[] contractAddress = PublicMethed
        .deployContract(contractName, abi, code, "",
            ...
            0, null, testKey002, fromAddress, blockingStubFull);
    Assert.assertTrue(PublicMethed
        .permissionAddKey(permission, contractAddress, 1, testAddress, dev001Key,
            blockingStubFull));
