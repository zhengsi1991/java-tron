...
public class MultiSignAddKey020 {
  ...
  public void testMultiSignAddKey() {
    ...
    Return returnResult = PublicMethedForMutiSign
        .permissionUpdateKey2(permission1, test001Address, 2, testAddress, dev001Key,
            blockingStubFull);
    Assert
