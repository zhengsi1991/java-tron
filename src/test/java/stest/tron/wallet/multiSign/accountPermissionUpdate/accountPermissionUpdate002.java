...
@Slf4j
public class accountPermissionUpdate002 {
  ...
  public void testOwnerTheshold01() {
    ...
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":-2147483648,\""
        + "parent\":\"owner\",\"keys\":["
  ...
  public void testOwnerTheshold02() {
    ...
    logger.info("** update owner and active permission to two address");
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":0,\""
        + "parent\":\"owner\",\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":2}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":3,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
  ...
  public void testOwnerTheshold04() {
    ...
    logger.info("** update owner and active permission to two address");
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":-9223372036854775808,\""
        + "parent\":\"owner\",\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":2}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":3,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
  ...
  public void testOwnerTheshold05() {
    ...
    logger.info("** update owner and active permission to two address");
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":-9223372036855775828,\""
        + "parent\":\"owner\",\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":2}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":3,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
  ...
  public void testOwnerTheshold06() {
    ...
    logger.info("** update owner and active permission to two address");
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":\"12a\",\""
        + "parent\":\"owner\",\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":2}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":3,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
  ...
  @Test
  public void testOwnerTheshold07() {
    // theshold = ""
    List<String> ownerPermissionKeys = new ArrayList<>();
    ...
    logger.info("** update owner and active permission to two address");
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":\"\",\""
        + "parent\":\"owner\",\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":2}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":3,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
  ...
  @Test
  public void testOwnerTheshold08() {
    // theshold =
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test
  public void testOwnerTheshold09() {
    // theshold = null
    List<String> ownerPermissionKeys = new ArrayList<>();
    ...
    logger.info("** update owner and active permission to two address");
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\": null,\""
        + "parent\":\"owner\",\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":2}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":3,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
  ...
  @Test
  public void testOwnerTheshold10() {
    // theshold = 1
    ...
    Assert.assertTrue(PublicMethedForMutiSign.permissionAddKey("owner", tmpAddr01, 1, ownerAddress,
  ...
  @Test
  public void testOwnerTheshold11() {
    ...
    logger.info("** update owner and active permission to two address");
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":4294967299,\""
        + "parent\":\"owner\",\"keys\":["
    ...
    Assert.assertFalse(response.getResult());
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals("contract validate error : sum of all key's weight should not be less than"
            + " threshold in permission owner",
        response.getMessage().toStringUtf8());
  }
  ...
  public void testOwnerTheshold12() {
    ...
    logger.info("** update owner and active permission to two address");
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":2147483647,\""
        + "parent\":\"owner\",\"keys\":["
  ...
  public void testOwnerTheshold13() {
    ...
    logger.info("** trigger a permission transaction");
    Assert.assertTrue(PublicMethedForMutiSign.permissionAddKey("active", tmpAddr01, 1, ownerAddress,
        ownerKey, blockingStubFull,
        ownerPermissionKeys.toArray(new String[ownerPermissionKeys.size()])));
  ...
  @Test
  public void testOwnerTheshold14() {
    // theshold = Integer.MAX_VALUE  < sum(weight)
    ECKey ecKey1 = new ECKey(Utils.getRandom());
    byte[] ownerAddress = ecKey1.getAddress();
    String ownerKey = ByteArray.toHexString(ecKey1.getPrivKeyBytes());
    ...
    logger.info("** trigger a permission transaction");
    Assert.assertTrue(PublicMethedForMutiSign.permissionAddKey("owner", tmpAddr01,
        1, ownerAddress, ownerKey, blockingStubFull,
        ownerPermissionKeys.toArray(new String[ownerPermissionKeys.size()])));
  ...
  @Test
  public void testOwnerTheshold15() {
    // theshold = Long.MAX_VALUE  < sum(weight)
    List<String> ownerPermissionKeys = new ArrayList<>();
    ...
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":9223372036854775807,\""
        ...
        + "{\"address\":\"" + PublicMethed.getAddressString(ownerKey) + "\",\"weight\":2147483647},"
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey01) + "\",\"weight\":1},"
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":9223372036854775807}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":3,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
        + "{\"address\":\"" + PublicMethed.getAddressString(ownerKey) + "\",\"weight\":1}]}]";
