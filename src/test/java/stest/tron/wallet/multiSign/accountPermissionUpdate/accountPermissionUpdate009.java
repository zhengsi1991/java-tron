...
@Slf4j
public class accountPermissionUpdate009 {
  ...
  public void testActiveWeight01() {
    ...
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":1,\""
        ...
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":2147483648},"
  ...
  public void testActiveWeight02() {
    ...
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":1,\""
        ...
        + "{\"address\":\"" + PublicMethed.getAddressString(ownerKey) + "\",\"weight\":0},"
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":0},"
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}]}]";
  ...
  public void testActiveWeight05() {
    ...
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":1,\""
        ...
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":-9223372036855775828},"
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}]}]";
  ...
  public void testActiveWeight06() {
    ...
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":1,\""
        ...
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":3,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":\"12a\"},"
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}]}]";
