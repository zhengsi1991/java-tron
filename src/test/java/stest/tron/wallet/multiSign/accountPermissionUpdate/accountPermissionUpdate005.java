...
@Slf4j
public class accountPermissionUpdate005 {
  ...
  public void testOwnerAddress01() {
    ...
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":2,\"keys\":["
  ...
  public void testOwnerAddress02() {
    ...
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":2,\"keys\":["
        ...
        + "{\"address\":\"" + PublicMethed.getAddressString(ownerKey) + "\",\"weight\":2147483644},"
        + "{\"address\":\"" + contractTRONdiceAddr + "\",\"weight\":1}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":5,\"keys\":["
  ...
  public void testOwnerAddress03() {
    ...
    logger.info("** trigger a permission transaction");
    Assert.assertTrue(PublicMethedForMutiSign.permissionAddKey("owner", witnessAddress001, 1, ownerAddress,
        ownerKey, blockingStubFull,
        ownerPermissionKeys.toArray(new String[ownerPermissionKeys.size()])));
  ...
  @Test
  public void testOwnerAddress04() {
  ...
  @Test
  public void testOwnerAddress05() {
    // address = owner_address twice
    List<String> ownerPermissionKeys = new ArrayList<>();
    ...
    Assert.assertEquals("contract validate error : address should be distinct in permission owner",
        response.getMessage().toStringUtf8());
  }


  @Test
  public void testOwnerAddress06() {
    // address = not exist
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test
  public void testOwnerAddress07() {
  ...
  @Test
  public void testOwnerAddress08() {
  ...
  @Test
  public void testOwnerAddress09() {
    // address count is 5
    ECKey ecKey1 = new ECKey(Utils.getRandom());
    byte[] ownerAddress = ecKey1.getAddress();
    String ownerKey = ByteArray.toHexString(ecKey1.getPrivKeyBytes());
    ...
    Assert.assertEquals(4, getPermissionCount(PublicMethed.queryAccount(ownerAddress,
        blockingStubFull).getPermissionsList(), "active"));
    ...
    logger.info("** trigger a permission transaction");
    Assert.assertTrue(PublicMethedForMutiSign.permissionAddKey("active", witnessAddress001, 1, ownerAddress,
        ownerKey, blockingStubFull,
        ownerPermissionKeys.toArray(new String[ownerPermissionKeys.size()])));
  ...
  @Test
  public void testOwnerAddress10() {
    // address count > 5
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test
  public void testOwnerAddress11() {
    // address count = 0
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test
  public void testOwnerAddress12() {
    // address count = 1
    ECKey ecKey1 = new ECKey(Utils.getRandom());
    byte[] ownerAddress = ecKey1.getAddress();
    String ownerKey = ByteArray.toHexString(ecKey1.getPrivKeyBytes());
    ...
    logger.info("** update owner and active permission to two address");
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":5,\"parent\":\"owner\",\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":5}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":1,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(ownerKey) + "\",\"weight\":2},"
        + "{\"address\":\"" + PublicMethed.getAddressString(testKey002) + "\",\"weight\":2},"
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":2},"
  ...
  @Test
  public void testOwnerAddress13() {
    // address =
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test
  public void testOwnerAddress14() {
    // address = null
