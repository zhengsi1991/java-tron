...
public class accountPermissionUpdate004 {
  ...
  public void testOwnerWeight04() {
    ...
    String accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":1,\""
        + "parent\":\"owner\",\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(ownerKey) + "\",\"weight\":3},"
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":-9223372036854775808},"
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}]},"
        + "{\"parent\":\"owner\",\"name\":\"active\",\"threshold\":3,\"keys\":["
        + "{\"address\":\"" + PublicMethed.getAddressString(witnessKey001) + "\",\"weight\":3},"
        + "{\"address\":\"" + PublicMethed.getAddressString(tmpKey02) + "\",\"weight\":1}]}]";
  ...
  public void testOwnerWeight13() {
    ...
    logger.info("** trigger a permission transaction");
    Assert.assertTrue(PublicMethedForMutiSign.permissionAddKey("active", tmpAddr01,
        1, ownerAddress, ownerKey, blockingStubFull,
        ownerPermissionKeys.toArray(new String[ownerPermissionKeys.size()])));
