...
@Slf4j
public class MultiSignAddKey027 {
  ...
  public void testMultiSignAddKey() {
    ...
    //address is notExistAddress

    String notExistAddress = "2323";

    Return returnResult = PublicMethedForMutiSign
        .permissionUpdateKey2(permission, notExistAddress.getBytes(), 2, testAddress, dev001Key,
            blockingStubFull);
    Assert
    ...
    Assert
        .assertThat(returnResult.getMessage().toStringUtf8(),
            containsString("you have not set owner permission"));
