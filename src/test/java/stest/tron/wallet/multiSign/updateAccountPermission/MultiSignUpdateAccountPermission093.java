...
@Slf4j
public class MultiSignUpdateAccountPermission093 {
...
//    PublicMethed.sendcoin(dev001Address, 100_000000, fromAddress, testKey002, blockingStubFull);
    ...
    dev001Key = "2C96633041AA038AF85C90E06A9905E1AF95F21C3056CFA17781528DB5EC4084";
    dev001Address = new WalletClient(dev001Key).getAddress();

    String permission = "[{\"keys\":[{\"address\":\"TLDoye4iTo9nkNN8NZ5uXiLQpQ5DH6fyyF\",\"weight\":2}],\"name\":\"owner\",\"threshold\":1,\"parent\":\"owner\"},{\"parent\":\"owner\",\"keys\":[{\"address\":\"TLDoye4iTo9nkNN8NZ5uXiLQpQ5DH6fyyF\",\"weight\":2}],\"name\":\"active\",\"threshold\":2}]";
