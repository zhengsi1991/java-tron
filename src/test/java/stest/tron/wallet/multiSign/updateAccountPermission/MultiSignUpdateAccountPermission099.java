...
@Slf4j
public class MultiSignUpdateAccountPermission099 {
...
//    PublicMethed.sendcoin(dev001Address, 1_000_000, fromAddress, testKey002, blockingStubFull);
    ...
    accountPermissionJson = "[{\"name\":\"owner\",\"threshold\":2,\"parent\":\"owner\",\"keys\":["
    ...
    ret = PublicMethedForMutiSign.permissionAddKey("owner", normalAddr001, 123,
        ownerAddress, ownerKey, blockingStubFull,
        ownerPermissionKeys.toArray(new String[ownerPermissionKeys.size()]));
...
//    PublicMethed.sendcoin(dev001Address, 1_000_000, fromAddress, testKey002, blockingStubFull);
    ...
    ret = PublicMethedForMutiSign.permissionAddKey("owner", witnessAddress001, 123,
        ownerAddress, ownerKey, blockingStubFull,
        ownerPermissionKeys.toArray(new String[ownerPermissionKeys.size()]));
  ...
  @Test
  public void test03AfterPermissionAdd() {
...
//    PublicMethed.sendcoin(dev001Address, 1_000_000, fromAddress, testKey002, blockingStubFull);
    ...
    for (String key : keyList) {
      ...
      boolean ret = PublicMethedForMutiSign.permissionAddKey("owner",
  ...
  @Test
  public void test04BeforePermissiondelete() {
...
//    PublicMethed.sendcoin(dev001Address, 1_000_000, fromAddress, testKey002, blockingStubFull);
    ...
    ret = PublicMethedForMutiSign.permissionDeleteKey("owner",
  ...
  @Test
  public void test05AfterPermissiondelete() {
...
//    PublicMethed.sendcoin(dev001Address, 1_000_000, fromAddress, testKey002, blockingStubFull);
    ...
    boolean ret = PublicMethedForMutiSign.permissionAddKey("active", normalAddr001, 123,
        ownerAddress, ownerKey, blockingStubFull,
        ownerPermissionKeys.toArray(new String[ownerPermissionKeys.size()]));
    ...
    ret = PublicMethedForMutiSign.permissionDeleteKey("active",
    ...
    ret = PublicMethedForMutiSign.accountPermissionUpdate(accountPermissionJson,
        ownerAddress, ownerKey, blockingStubFull,
        ownerPermissionKeys.toArray(new String[ownerPermissionKeys.size()]));
  ...
  @Test
  public void test06AfterPermissionUpdate() {
...
//    PublicMethed.sendcoin(dev001Address, 1_000_000, fromAddress, testKey002, blockingStubFull);
    ...
    boolean ret = PublicMethedForMutiSign.permissionUpdateKey("owner",
  ...
  @Test
  public void test07BeforePermissionUpdate() {
...
//    PublicMethed.sendcoin(dev001Address, 1_000_000, fromAddress, testKey002, blockingStubFull);
    ...
    logger.info("** permissionupdate 1 Addrs to owner permission");
    ret = PublicMethedForMutiSign.permissionUpdateKey("owner",
