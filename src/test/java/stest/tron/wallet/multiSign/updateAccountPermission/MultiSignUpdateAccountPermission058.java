...
@Slf4j
public class MultiSignUpdateAccountPermission058 {
...
//    PublicMethed.sendcoin(dev001Address, 100_000000, fromAddress, testKey002, blockingStubFull);
    ...
    String permission = "[{\"keys\":[{\"address\":\"TR3FAbhiSeP7kSh39RjGYpwCqfMDHPMhX4\",\"weight\":1}],\"name\":\"owner\",\"threshold\":1,\"parent\":\"owner\"},{\"parent\":\"owner\",\"keys\":[{\"address\":\"TR3FAbhiSeP7kSh39RjGYpwCqfMDHPMhX4\",\"weight\":2147483645},{\"address\":\"TWNxQr5QpuH6FMTDesf4PJEshPumS8fhZ7\",\"weight\":1}],\"name\":\"active\",\"threshold\":2147483647}]";
    ...
    Assert.assertEquals("contract validate error : sum of all key's weight should not be less than threshold in permission active",
