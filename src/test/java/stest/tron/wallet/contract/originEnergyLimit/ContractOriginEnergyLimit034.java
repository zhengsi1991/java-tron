...
@Slf4j
public class ContractOriginEnergyLimit034 {
...
//    Assert.assertTrue(userBalanceBefore - EnergyFeeAutual == userBalanceAfter);
    ...
    Assert.assertEquals(userEnergyUsageAfter, triggerFeeLimit / 100);
  }
