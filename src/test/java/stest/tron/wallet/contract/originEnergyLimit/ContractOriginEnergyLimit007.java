...
@Slf4j
public class ContractOriginEnergyLimit007 {
...
//    logger.info("User feeLimit: " + getFeeLimit(txid)*10000);
  ...
  public void testOriginEnergyLimit() {
    ...
    long originEnergyLimit = maxFeeLimit;
    ...
    //original energy limit 1000000000, percent 0
//    contractAddress  = WalletClient.decodeFromBase58Check("TAXGm93AzBstinGtUC3Fray2mU5nMzEm18");
    //original energy limit 1000, percent 0
//    contractAddress  = WalletClient.decodeFromBase58Check("TBJa1aexrWhL7CTgoqR49Mq9NjDpg8evqA");
    //original energy limit 500, percent 0
//    contractAddress  = WalletClient.decodeFromBase58Check("TVP8eWBK7v9VZtSLhpnfjxwqP9cRn9SS1c");

    //original energy limit 1000000000, percent 75
//    contractAddress  = WalletClient.decodeFromBase58Check("TV7Phm23i7DVxPuX6kgxcGrEqW75BoCywJ");
    //original energy limit 1000, percent 75
//    contractAddress  = WalletClient.decodeFromBase58Check("TQs5X9iYStGhDzGeKtuAocM7iqNDrVGYRK");
    //original energy limit 100, percent 75
//    contractAddress  = WalletClient.decodeFromBase58Check("TMgjqPZzSwR784xKjEiPbdkYgkA7ssS2pq");

    // deploy by myself:
//    contractAddress = WalletClient.decodeFromBase58Check("TM2FViJspqq1mQ5nvfnJQTq77pGWEQd9eB");

    // TronDice
//     contractAddress = WalletClient.decodeFromBase58Check("TWY8dqZun9EU4tA3B4icnCE77HrP5FN7be");
