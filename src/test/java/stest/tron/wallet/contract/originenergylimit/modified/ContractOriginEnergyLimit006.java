...
@Slf4j
public class ContractOriginEnergyLimit006 extends ContractOriginEnergyLimit005 {
...
//    Assert.assertEquals(devEnergyUsageAfter, devEnergyUsageBefore + devMax);
    ...
    logger.info("waitnew userExpectCost: " + userExpectCost);
