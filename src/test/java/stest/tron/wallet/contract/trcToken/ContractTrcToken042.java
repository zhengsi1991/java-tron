...
@Slf4j
public class ContractTrcToken042 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractTrcToken042_transferTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractTrcToken042_transferTokenContract");
  ...
  public void test02DeployRevContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractTrcToken042_recieveTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractTrcToken042_recieveTokenContract");
  ...
  public void test03TriggerContract() {
    ...
    Long tokenValue = Long.MIN_VALUE;
