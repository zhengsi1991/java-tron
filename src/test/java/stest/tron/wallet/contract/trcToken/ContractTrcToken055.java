...
public class ContractTrcToken055 {
  ...
  public void continueRun() {
    ...
    Long callvalueF = 0L;
    Long tokenvalueF = 0L;
    String fakeTokenId = Long.toString(Long.MIN_VALUE);
    String fakeTokenId2 = Long.toString(0);
    String fakeTokenId3 = Long.toString(-1);
    String fakeTokenId4 = Long.toString(Long.MAX_VALUE);
    Long fakeTokenIdLong = Long.valueOf(tokenId.toStringUtf8()) + 1000;
    ByteString fakeTokenId5 = ByteString.copyFromUtf8(String.valueOf(fakeTokenIdLong));
    ...
    String triggerTxid2 = PublicMethed.triggerContract(transferTokenContractAddress,
        "msgTokenValueAndTokenIdTest()", "#", false, callvalueF,
        1000000000L, fakeTokenId3, tokenvalueF, user001Address, user001Key,
        blockingStubFull);
    String triggerTxid3 = PublicMethed.triggerContract(transferTokenContractAddress,
        "msgTokenValueAndTokenIdTest()", "#", false, callvalueF,
        1000000000L, fakeTokenId4, tokenvalueF, user001Address, user001Key,
        blockingStubFull);
    String triggerTxid4 = PublicMethed.triggerContract(transferTokenContractAddress,
        "msgTokenValueAndTokenIdTest()", "#", false, callvalueF,
        1000000000L, fakeTokenId5.toStringUtf8(), tokenvalueF, user001Address, user001Key,
        blockingStubFull);
    ...
    Assert.assertEquals(fakeTokenId, String.valueOf(id));
    ...
    logger.info("id:" + id1);
    logger.info("tokenValue:" + tokenValue1);
    logger.info("callValue:" + callValue1);

    Assert.assertEquals(fakeTokenId2, String.valueOf(id1));
    ...
    Assert.assertEquals(fakeTokenId3, String.valueOf(id2));
    ...
    logger.info("id:" + id3);
    logger.info("tokenValue:" + tokenValue3);
    logger.info("callValue:" + callValue3);

    Assert.assertEquals(fakeTokenId4, String.valueOf(id3));
    Assert.assertTrue(callvalueF == callValue3);
    Assert.assertTrue(tokenvalueF == tokenValue3);

    List<String> retList4 = getStrings(infoById4.get().getContractResult(0).toByteArray());
    Long id4 = ByteArray.toLong(ByteArray.fromHexString(retList4.get(0)));
    Long tokenValue4 = ByteArray.toLong(ByteArray.fromHexString(retList4.get(1)));
    Long callValue4 = ByteArray.toLong(ByteArray.fromHexString(retList4.get(2)));
    logger.info("id:" + id4);
    logger.info("tokenValue:" + tokenValue4);
    logger.info("callValue:" + callValue4);

    Assert.assertEquals(fakeTokenId5.toStringUtf8(), String.valueOf(id4));
    Assert.assertTrue(callvalueF == callValue4);
    Assert.assertTrue(tokenvalueF == tokenValue4);
