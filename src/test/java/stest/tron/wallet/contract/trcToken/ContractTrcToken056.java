...
@Slf4j
public class ContractTrcToken056 {
  ...
  public void continueRun() {
    ...
    String tokenName1 = "testAI_" + randomInt(10000, 90000);
    ByteString tokenId2 = createAssetissue(dev001Address, dev001Key, tokenName1);

    // devAddress transfer token to A
    PublicMethed.transferAsset(dev001Address, tokenId.toByteArray(), 200, user001Address,
        user001Key, blockingStubFull);
    PublicMethed
        .transferAsset(user001Address, tokenId2.toByteArray(), 200, dev001Address,
            dev001Key,
            blockingStubFull);
    ...
    byte[] transferTokenContractAddress = PublicMethed
        .deployContract(contractName, abi, code, "", maxFeeLimit,
            0L, 100, 10000, tokenId2.toStringUtf8(),
            1, null, dev001Key, dev001Address,
            blockingStubFull);
    ...
    PublicMethed
        .transferAsset(transferTokenContractAddress, tokenId.toByteArray(), 100, dev001Address,
            ...
            blockingStubFull);
    PublicMethed
        .transferAsset(transferTokenContractAddress, tokenId2.toByteArray(), 100, dev001Address,
            dev001Key,
            blockingStubFull);
    ...
    Long beforeAssetIssue2Count = getAssetIssueValue(user001Address, tokenId2, blockingStubFull);
    ...
    Long beforeAssetIssueDev = getAssetIssueValue(dev001Address, tokenId,
        blockingStubFull);
    Long beforeAssetIssueContract2Address = getAssetIssueValue(transferTokenContractAddress,
        tokenId2,
        blockingStubFull);
    ...
    logger.info("beforeAssetIssueContract2Address:" + beforeAssetIssueContract2Address);
    ...
    String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        ...
        1000000000L, tokenId2.toStringUtf8(), tokenvalueF, user001Address, user001Key,
        blockingStubFull);
    ...
    Long afterAssetIssue2Count = getAssetIssueValue(user001Address, tokenId2, blockingStubFull);

    Long afterNetUsed = resourceInfoafter.getNetUsed();
    Long afterFreeNetUsed = resourceInfoafter.getFreeNetUsed();
    Long afterAssetIssueContractAddress = getAssetIssueValue(transferTokenContractAddress, tokenId,
        blockingStubFull);
    Long afterAssetIssueContract2Address = getAssetIssueValue(transferTokenContractAddress,
        tokenId2,
        blockingStubFull);
    ...
    logger.info("afterAssetIssueContract2Address:" + afterAssetIssueContract2Address);
    ...
    Assert.assertEquals(tokenId2.toStringUtf8(), String.valueOf(id));
    ...
    Assert.assertTrue(beforeAssetIssueContract2Address + 1 == afterAssetIssueContract2Address);
    Assert.assertTrue(beforeAssetIssue2Count - 1 == afterAssetIssue2Count);
