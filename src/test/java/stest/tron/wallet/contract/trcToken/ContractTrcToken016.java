...
public class ContractTrcToken016 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    assetAccountUser = PublicMethed.queryAccount(dev001Address, blockingStubFull)
        .getAssetIssuedID();
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractTrcToken016_transferTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractTrcToken016_transferTokenContract");
  ...
  public void test02DeployRevContract() {
    ...
    final String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractTrcToken016_transferTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractTrcToken016_transferTokenContract");
