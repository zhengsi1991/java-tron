...
@Slf4j
public class ContractTrcToken017 {
  ...
  public void test02DeployRevContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractTrcToken017_recieveTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractTrcToken017_recieveTokenContract");
    ...
    Long contractAssetCount = PublicMethed.getAssetIssueValue(receiveTokenContractAddress,
        assetAccountId, blockingStubFull);
    logger.info("Contract has AssetId: " + assetAccountId.toStringUtf8() + ", Count: "
        + contractAssetCount);
  ...
  public void test03TriggerContract() {
    ...
    Long receiveAssetBefore = PublicMethed
        .getAssetIssueValue(receiveTokenContractAddress, assetAccountId,
            blockingStubFull);
    ...
    param = "\"" + Base58.encode58Check(receiveTokenContractAddress)
        + "\"," + fackTokenId + ",\"" + fakeValue + "\"";
    ...
    Long receiveAssetAfter = PublicMethed.getAssetIssueValue(receiveTokenContractAddress,
        assetAccountId, blockingStubFull);
