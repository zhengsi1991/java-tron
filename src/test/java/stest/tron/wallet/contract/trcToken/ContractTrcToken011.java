...
//    Assert.assertEquals(balanceBefore, balanceAfter);
  ...
  public void triggerContract(byte[] transferTokenContractAddress,
    ...
    logger.info(
        "the value: " + getStrings(transactionInfo.getLogList().get(0).getData().toByteArray()));
  ...
  public void triggerTokenBalanceContract(byte[] tokenBalanceContractAddress,
    ...
    Long assetIssueCount = getAssetIssueValue(receiveTokenContractAddress, assetAccountId,
        blockingStubFull);
