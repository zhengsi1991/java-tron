...
//    logger.info("The msg value: " +  getStrings(infoById.get().getContractResult(0).toByteArray()));
    ...
    Long msgTokenBalance = ByteArray.toLong(infoById.get().getLogList().get(0).getTopicsList().get(0).toByteArray());
    Long msgId = ByteArray.toLong(infoById.get().getLogList().get(0).getTopicsList().get(1).toByteArray());
    Long msgTokenValue = ByteArray.toLong(infoById.get().getLogList().get(0).getTopicsList().get(2).toByteArray());
    Long msgCallValue = ByteArray.toLong(infoById.get().getLogList().get(0).getTopicsList().get(3).toByteArray());
