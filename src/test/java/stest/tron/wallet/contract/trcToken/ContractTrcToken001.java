...
public class ContractTrcToken001 {
  ...
  public static long getFreezeBalanceCount(byte[] accountAddress, String ecKey, Long targetEnergy,
    ...
    if (needBalance < 1000000L) {
      ...
      logger.info("[Debug]getFreezeBalanceCount, needBalance less than 1 TRX,"
          + " modify to: " + needBalance);
    }
    return needBalance;
  }
  ...
  private ByteString testCreateAssetIssue(byte[] accountAddress, String priKey) {
    ...
    if (queryAssetByAccount.get().getAssetIssueCount() == 0) {
      ...
      Account getAssetIdFromThisAccount =
          PublicMethed.queryAccount(accountAddress, blockingStubFull);
      ...
      tokenName = ByteArray.toStr(
          queryAssetByAccount1.get().getAssetIssue(0).getName().toByteArray());
    }
