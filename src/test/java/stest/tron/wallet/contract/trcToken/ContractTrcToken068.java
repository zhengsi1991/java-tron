...
public class ContractTrcToken068 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    assetAccountUser = PublicMethed.queryAccount(user001Address, blockingStubFull).getAssetIssuedID();
  ...
  public void test02DeployRevContract() {
    ...
    logger.info("after energyUsage is " + Long.toString(energyUsage));
    logger.info("after balanceAfter is " + Long.toString(balanceAfter));
    logger.info("after AssetId: " + assetAccountId.toStringUtf8() + ", devAssetCountAfter: " + devAssetCountAfter);
